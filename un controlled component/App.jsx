...
// ADD TO SEND STATE VARIABLES EG : setTrainerId 
    ...
    <>
      ...
      <Router>
        ...
        <Routes>
          ...
          element={<StudentLogin setStudentId={setStudentId}>
             <p>Welcome Student</p> </StudentLogin>} />

          <Route path="/trainerlogin" 
          element={<TrainerLogin setTrainerId={setTrainerId}> <p>Welcome Trainer</p> </TrainerLogin>} />

          <Route path="/studentdetails" element={<StudentDetails
           id={studentId} />} />

          <Route path="/trainerdetails" element={<TrainerDetails id={trainerId} />} />
          <Route path="/Feedback" element={<Feedback setFeedbackId={setFeedbackId}>
            <p> Welcome to Feedback</p> </Feedback>}></Route>
        </Routes>
      </Router>
